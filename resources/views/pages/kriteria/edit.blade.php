        ...
        <div class="card-body">
            ...
            <form action="{{ route('kriteria.update',$kriteria->id_kriteria)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputNim" placeholder="Masukan NIM" name="nama_kriteria" value="{{ $kriteria->nama_kriteria }}">
                </div>
                <div class="form-group">
                    <label for="inputNama">Bobot Kriteria</label>
                    <input type="text" class="form-control" id="inputNama" placeholder="Masukan Nama" name="bobot_kriteria" value="{{ $kriteria->bobot_kriteria }}">
                </div>
